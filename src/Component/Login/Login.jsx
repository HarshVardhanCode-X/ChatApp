...
import { createUserWithEmailAndPassword, GithubAuthProvider, signInWithEmailAndPassword, signInWithPopup, signInWithRedirect, signOut } from "firebase/auth";
...
function Login() {
    ...
    const signInWithMailCreate = async (e) => {
        e.preventDefault()
        try {
